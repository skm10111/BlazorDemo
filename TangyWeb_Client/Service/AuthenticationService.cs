...
namespace TangyWeb_Client.Service
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private readonly AuthenticationStateProvider _auhtenticationStateProvider;

        public AuthenticationService(HttpClient client, ILocalStorageService localStorage, AuthenticationStateProvider auhtenticationStateProvider )
        {
            _client = client;
            _localStorage = localStorage;
            _auhtenticationStateProvider = auhtenticationStateProvider;
        }
        ...
        public async Task<SignInResponseDTO> Login(SignInRequestDTO signInRequest)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                ((AuthStateProvider)_auhtenticationStateProvider).NotifyUserLoggedIn(result.Token);
        ...
        public async Task Logout()
        {
            ...
            ((AuthStateProvider)_auhtenticationStateProvider).NotifyUserLogout();
